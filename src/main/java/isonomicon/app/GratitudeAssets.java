...
public class GratitudeAssets extends ApplicationAdapter {
    ...
    public static final String ANIMATION_PATH = "out/gratitude/animated/";
    public static final String ANIMATION_PATH_PALETTE = "out/gratitude/animated_snuggly/";
...
//                    pixmap = Pixmap.createFromFrameBuffer(0, 0, t.getWidth(), t.getHeight());
                        ...
                        fb.end();
                        pm.add(pixmap);
                        png.write(Gdx.files.local("out/gratitude/png/" + output + '/' + output + "_angle" + i + "_" + f + ".png"), pixmap);
                        if (p == 0) {
                            png.write(Gdx.files.local("out/gratitude/lab/" + name + '/' + name + "_angle" + i + "_" + f + ".png"), renderer.palettePixmap);
                        }
                        palette.dispose();
                    }
                }
