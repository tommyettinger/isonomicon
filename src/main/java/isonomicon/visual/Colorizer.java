...
//                - Math.min(color.r, Math.min(color.g, color.b))) * 0x1.6p-5f;
     ...
     * color used in a model. The color at index 0 is "bright", index 2 is "dim", and index 3 is "dark". Ramp arrays
     *like this can be used to figure out what indices are related to
