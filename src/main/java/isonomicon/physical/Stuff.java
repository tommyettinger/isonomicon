...
public class Stuff {
    ...
    public static final Stuff[] STUFFS = new Stuff[]{
            ...
            new Stuff("magic rune", 59, 0, 2L, "Roughness 0.25 Reflection 0.65 Emission 0.3"),
            ...
            new Stuff("dark glass", 64, 69, 0L, "Transparency 0.75 Roughness 0.0 Reflection 0.4"),
            ...
            new Stuff("brown glass", 89, 79, 0L, "Transparency 0.75 Roughness 0.0 Reflection 0.65"),
            ...
            new Stuff("darkened pool", 102, 0, -1L, "Roughness 0.0 Reflection 0.0 Wave 0.1"),
            ...
            new Stuff("splash ascent", 106, 0, -1L, "Roughness 0.6 Reflection 0.6 Wave 0.4 Rise 0.1", 106, 2, 107, 6, 109, 1),
            new Stuff("splash apex", 107, 0, -1L, "Roughness 0.7 Reflection 0.95 Wave 0.6", 107, 2, 108, 6, 106, 1),
            new Stuff("splash descent", 108, 0, -1L, "Roughness 0.5 Reflection 0.5 Wave 0.5 -Rise 0.1", 108, 2, 109, 6, 107, 1),
            new Stuff("splash nadir", 109, 0, -1L, "Roughness 0.4 Reflection 0.3 Wave 0.7", 109, 2, 106, 6, 108, 1),
            ...
            new Stuff("subtle mote", 112, 0, 0L, "Emission 0.2 Roughness 0.0 Reflection 0.0 Transparency 1.0", 112, 5, 110, 3),
            new Stuff("dread spawner", 113, 0, 0L, "Transparency 1.0", 114, 1, 113, 11),
            new Stuff("dread", 114, 120, 0L, "Emission -0.4 Roughness 0.0 Reflection 0.0 Transparency 1.0 Missing 0.1", 114, 4, 113, 3),
            new Stuff("unknown energy", 115, 0, 0L, "Emission 0.4 Roughness 0.3 Reflection 0.0 Wave 0.7 Missing 0.4", 115, 5, 117, 1, 0, 1),
            ...
            new Stuff("powerful mote", 123, 0, 0L, "Emission 0.6 Roughness 0.0 Reflection 0.0 Transparency 1.0", 123, 5, 110, 3),
