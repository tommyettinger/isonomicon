...
//        this.material.traits.putIfAbsent(VoxMaterial.MaterialTrait._damage.ordinal(), id);
    ...
    public static final Stuff[] STUFFS_B = new Stuff[]{
            ...
            new Stuff("shadow", 66, 69, "Roughness 0.0 Reflection 0.0 Emission -0.05"),
    ...
    public static final Stuff[] STUFFS_C = new Stuff[]{
            ...
            new Stuff("raw fabric low", 133,  "Roughness 0.35 Reflection 0.04 Dapple -0.1 Vary -0.1"),
            new Stuff("raw fabric base", 134, "Roughness 0.4 Reflection 0.03 Dapple -0.1 Vary -0.1"),
            new Stuff("raw fabric high", 135, "Roughness 0.5 Reflection 0.02 Dapple -0.1 Vary -0.1"),
            ...
            new Stuff("patina", 170, "Roughness 0.7 Reflection 0.2 Vary -0.4"),
            new Stuff("clear glass", 171, "Transparency 0.25 Roughness 0.0 Reflection 0.65 Damage 54"),
            new Stuff("rough gem", 172, "Roughness 0.8 Reflection 0.4 Transparency 0.1 Dapple -0.06"),
            ...
            new Stuff("ink low", 190,  "Roughness 0.0 Reflection 0.1"),
            new Stuff("ink base", 191, "Roughness 0.0 Reflection 0.2"),
            new Stuff("ink high", 192, "Roughness 0.0 Reflection 0.3"),
