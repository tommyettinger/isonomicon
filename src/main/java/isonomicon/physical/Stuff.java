...
public class Stuff {
    ...
    public static final Stuff[] STUFFS = new Stuff[]{
            ...
            new Stuff("gas", 36, 0, 256L, "Roughness 0.25 Reflection 0.0"),
            ...
            new Stuff("fast water", 43, 0, -1L, "Roughness 0.2 Reflection 0.75 Missing 0.15"),
            ...
            new Stuff("deep water", 49, 0, -1L, "Roughness 0.3 Reflection 0.5"),
            new Stuff("more obscured", 50, 50, -1L, "Roughness 0.2 Reflection 0.0"),
            new Stuff("eerie matter", 51, 51, 64L, "Roughness 0.55 Reflection 0.4 Missing 0.15 Emission 0.05"),
            new Stuff("eerie slime", 52, 0, -1L, "Roughness 0.2 Reflection 0.7 Missing 0.25 Emission 0.2"),
            new Stuff("eerie device", 53, 53, 1L, "Roughness 0.1 Reflection 0.6 Emission 0.35"),
            new Stuff("phantasm", 54, 8, -1L, "Roughness 0.85 Reflection 0.2 Missing 0.4 Emission 0.1"),
            new Stuff("tentacle", 55, 55, 4L, "Roughness 0.45 Reflection 0.6"),
